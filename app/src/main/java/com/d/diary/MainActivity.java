...
import com.d.diary.adapters.NotesAdapter;
import com.d.diary.callbacks.MainActionModeCallback;
import com.d.diary.callbacks.NoteEventListener;
import com.d.diary.db.NotesDB;
import com.d.diary.db.NotesDao;
import com.d.diary.model.Note;
import com.d.diary.utils.NoteUtils;
...
import static com.d.diary.EditNoteActivity.NOTE_EXTRA_Key;
    ...
    private void setupNavigation(Bundle savedInstanceState, Toolbar toolbar) {
        ...
        AccountHeader header = new AccountHeaderBuilder().withActivity(this)
                .addProfiles(new ProfileDrawerItem()
                        .withEmail("dipankarboruah@gmail.com")
                        .withName("BD")
